...
Specifica quando le modifiche apportate da un utente ai dati contenuti in un file possano essere osservate da altri utenti. È correlata agli [[Race_condition|algoritmi di sincronizzazione fra processi]], anche se tende ad essere meno critica a causa delle lunghe latenze e delle basse velocità di trasferimento dei dischi e della rete.
